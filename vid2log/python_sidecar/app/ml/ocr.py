...
from app.bundle import configure_tesseract

log = logging.getLogger(__name__)

# Points pytesseract at the Tesseract shipped inside the app bundle, when
# there is one. A no-op when running from source, where the system-installed
# `tesseract` on PATH is used instead. Done at import time so every caller
